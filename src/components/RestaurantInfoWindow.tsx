...
export default function RestaurantInfoWindow({
  restaurant,
}: RestaurantInfoWindowProps) {
  ...
  return (
    <div className="min-w-[240px] max-w-[300px]">
      ...
      <a
        ...
        className="inline-flex items-center gap-1.5 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors w-full justify-center shadow-sm"
      >
